...
class TestNBVICalibrator:
    ...
    def test_custom_parameters(self):
        ...
        calibrator = NBVICalibrator(buffer_size=1000, percentile=15, alpha=0.4, min_spacing=5)
...
class TestNoiseGate:
    ...
    def test_noise_gate_keeps_strong(self):
        ...
        metrics = [{"subcarrier": i, "mean": 30.0 + i, "nbvi": 0.1} for i in range(20)]
    ...
    def test_noise_gate_all_weak(self):
        ...
        metrics = [{"subcarrier": i, "mean": 0.5, "nbvi": 0.1} for i in range(20)]
...
class TestSpectralSpacing:
    ...
    def test_select_top_5_always_included(self):
        ...
        metrics = [{"subcarrier": i, "nbvi": i * 0.01} for i in range(30)]
    ...
    def test_select_returns_correct_count(self):
        ...
        metrics = [{"subcarrier": i, "nbvi": i * 0.01} for i in range(64)]
    ...
    def test_select_respects_spacing(self):
        ...
        metrics = [{"subcarrier": i, "nbvi": 0.01 if i < 10 else 0.1} for i in range(64)]
    ...
    def test_select_fewer_than_k(self):
        ...
        metrics = [{"subcarrier": i * 5, "nbvi": i * 0.01} for i in range(8)]
    ...
    def test_select_exact_k(self):
        ...
        metrics = [{"subcarrier": i * 4, "nbvi": i * 0.01} for i in range(12)]
...
class TestBaselineWindow:
    ...
    def test_find_baseline_insufficient_packets(self):
        ...
        candidates = calibrator._find_candidate_windows(current_band, window_size=50, step=25)
    ...
    def test_find_baseline_with_stable_data(self):
        ...
        candidates = calibrator._find_candidate_windows(current_band, window_size=100, step=50)

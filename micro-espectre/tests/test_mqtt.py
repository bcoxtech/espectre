...
class TestMQTTHandler:
    ...
    def test_init_with_traffic_generator(self, mock_config, mock_segmentation, mock_wlan, mock_traffic_gen):
        ...
        handler = MQTTHandler(mock_config, mock_segmentation, mock_wlan, traffic_generator=mock_traffic_gen)
    ...
    def test_publish_state_error_handling(self, mock_config, mock_segmentation, mock_wlan, mock_mqtt_client_instance):
        ...
        handler.publish_state(
            current_variance=0.5, current_state=0, current_threshold=1.0, packet_delta=100, dropped_delta=0, pps=100
        )
...
class TestMQTTCommands:
    ...
    def commands_instance(
        self, mock_mqtt_client_instance, mock_config, mock_segmentation, mock_wlan, mock_traffic_gen, mock_global_state
    ):
    ...
    def test_cmd_segmentation_window_size_success(
        self, commands_instance, mock_mqtt_client_instance, mock_segmentation
    ):
    ...
    def test_cmd_factory_reset_ml_uses_ml_default_threshold(
        self, mock_mqtt_client_instance, mock_config, mock_traffic_gen, mock_global_state
    ):
    ...
    def test_cmd_info_with_connected_wlan(
        self, mock_mqtt_client_instance, mock_config, mock_segmentation, mock_traffic_gen, mock_global_state
    ):
    ...
    def test_cmd_info_with_inactive_wlan(
        self, mock_mqtt_client_instance, mock_config, mock_segmentation, mock_traffic_gen, mock_global_state
    ):

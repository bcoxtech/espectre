...
class TestNormalizeFeatures:
    ...
    def test_normalization_changes_values(self):
        ...
        features = [10.0, 5.0, 20.0, 1.0, 15.0, 8.0, 3.0, 2.5, 0.5, -0.5, 0.1, 5.0][:MODEL_INPUT_SIZE] + [1.0] * max(
            0, MODEL_INPUT_SIZE - 12
        )
        result = normalize_features(features)
...
class TestPredict:
    ...
    def test_predict_returns_float(self):
        ...
        features = [14.0, 2.0, 17.0, 9.0, 0.30, -1.5, 8.0, 2.0, 0.15, 0.7, 0.001, 0.0][:MODEL_INPUT_SIZE] + [0.0] * max(
            0, MODEL_INPUT_SIZE - 12
        )

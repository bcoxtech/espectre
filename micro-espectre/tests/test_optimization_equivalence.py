...
@pytest.fixture
def turbulence_values(real_csi_data_available, real_baseline_packets, real_movement_packets, default_subcarriers):
    ...
    def test_variance_within_tolerance(self, turbulence_values):
        ...
        for i, value in enumerate(turbulence_values):
            ...
            if diff > TOLERANCE and (orig_var > 0 or opt_var > 0):
                mismatches.append({"index": i, "original": orig_var, "optimized": opt_var, "diff": diff})
...
class TestHampelEquivalence:
    ...
    def test_hampel_within_tolerance(self, turbulence_values):
        ...
        for i, value in enumerate(turbulence_values):
            ...
            if diff > TOLERANCE:
                mismatches.append({"index": i, "input": value, "original": orig_filtered, "optimized": opt_filtered})

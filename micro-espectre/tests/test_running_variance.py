...
class TestRealCSIData:
    ...
    def test_real_csi_variance_equivalence(
        self, real_csi_data_available, real_baseline_packets, real_movement_packets, default_subcarriers
    ):
    ...
    def test_buffer_contents_match(
        self, real_csi_data_available, real_baseline_packets, real_movement_packets, default_subcarriers
    ):
...
class TestDetectionEquivalence:
    ...
    def test_state_machine_equivalence(
        self, real_csi_data_available, real_baseline_packets, real_movement_packets, default_subcarriers
    ):

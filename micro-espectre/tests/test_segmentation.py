...
class TestSegmentationContextInit:
    ...
    def test_custom_parameters(self):
        ...
        ctx = SegmentationContext(window_size=100, threshold=2.5, enable_hampel=False)
    ...
    def test_hampel_enabled(self):
        ...
        ctx = SegmentationContext(enable_hampel=True, hampel_window=5, hampel_threshold=3.0)
        assert ctx.hampel_filter is not None
...
class TestHampelIntegration:
    ...
    def test_hampel_filters_outliers(self):
        ...
        ctx = SegmentationContext(window_size=10, enable_hampel=True, hampel_window=5, hampel_threshold=3.0)
...
class TestLowPassIntegration:
    ...
    def test_lowpass_smooths_signal(self):
        ...
        ctx = SegmentationContext(window_size=50, enable_lowpass=True, lowpass_cutoff=10.0)
...
class TestCalculateSpatialTurbulence:
    ...
    def test_stores_amplitudes(self, synthetic_csi_packet, default_subcarriers):
        ...
        turb, amps = ctx.calculate_spatial_turbulence(synthetic_csi_packet, default_subcarriers, return_amplitudes=True)
